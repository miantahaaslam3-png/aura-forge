#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Aura Forge docs site.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Aura Forge"),
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append("Repo: https://github.com/miantahaaslam3-png/aura-forge")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Aura Forge Agent — Full Documentation\n",
        (
            "This file is the entire Aura Forge Agent documentation concatenated for LLM "
