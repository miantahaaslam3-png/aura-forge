...
sidebar_position: 2
title: "添加工具"
description: "如何向 Aura Forge Agent 添加新工具——schema、handler、注册与 toolset"
---
...
:::warning 仅限内置核心工具
本页面用于向仓库本身添加 **Aura Forge 内置工具**。
如果你想要个人专用、项目本地或其他自定义工具，而不修改 Aura Forge 核心，请使用插件方式：

- [插件](/user-guide/features/plugins)
- [构建 Aura Forge 插件](/developer-guide/plugins)
...
如果你的工具需要 API 密钥，将其添加到 `auraforge_cli/config.py`：
...
- [ ] 可选：已将 API 密钥添加到 `auraforge_cli/config.py` 的 `OPTIONAL_ENV_VARS`
