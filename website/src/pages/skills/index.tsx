...
export default function SkillsDashboard() {
  ...
  // app (Aura Forge desktop's Bot Mode agent editor) as a skill PICKER. Site
  ...
  return (
    <Layout
      title="Skills Hub"
      description="Browse all skills and plugins available for Aura Forge Agent"
    >
      <div className={`${styles.page} ${pickerMode ? styles.pickerMode : ""}`}>
        <header className={styles.hero}>
          <div className={styles.heroGlow} />
          <div className={styles.heroContent}>
            <p className={styles.heroEyebrow}>Aura Forge Agent</p>
