  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Aura Forge Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Aura Forge &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Aura Forge?{' '}
        <a
          href="https://github.com/miantahaaslam3-png/aura-forge/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
