...
```bash
# Run the desktop app
nix run github:miantahaaslam3-png/aura-forge#desktop

# Or install persistently
nix profile install github:miantahaaslam3-png/aura-forge#desktop

# run the tui
nix run github:miantahaaslam3-png/aura-forge -- setup
nix run github:miantahaaslam3-png/aura-forge -- --tui
