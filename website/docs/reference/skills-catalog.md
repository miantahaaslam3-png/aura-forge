...
| [`aura-forge-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-aura-forge-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/aura-forge-agent-skill-authoring` |
| [`inspecting-auraforge-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-auraforge-desktop-dom) | Read the live Hermes desktop DOM/CSS over CDP. | `software-development/inspecting-auraforge-desktop-dom` |
