...
3. For each merged PR, check if it modified:
   ...
   - CLI commands (auraforge_cli/commands.py, auraforge_cli/main.py) — may need docs/reference/cli-commands.md update
   - Config options (auraforge_cli/config.py) — may need docs/user-guide/configuration.md update
