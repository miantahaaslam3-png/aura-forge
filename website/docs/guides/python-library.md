...
```bash
pip install git+https://github.com/miantahaaslam3-png/aura-forge.git
```

Or with [uv](https://docs.astral.sh/uv/):

```bash
uv pip install git+https://github.com/miantahaaslam3-png/aura-forge.git
```

You can also pin it in your `requirements.txt`:

```text
hermes-agent @ git+https://github.com/miantahaaslam3-png/aura-forge.git
```
