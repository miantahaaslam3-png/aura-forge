...
If a model is genuinely missing, [open an issue](https://github.com/miantahaaslam3-png/aura-forge/issues) — we surface the Portal's catalog to Hermes and gaps usually mean a routing config we can update.
