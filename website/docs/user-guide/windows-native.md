...
```powershell
iex (irm https://raw.githubusercontent.com/miantahaaslam3-png/aura-forge/main/scripts/install.ps1)
```
...
```powershell
& ([scriptblock]::Create((irm https://raw.githubusercontent.com/miantahaaslam3-png/aura-forge/main/scripts/install.ps1))) -NoVenv -SkipSetup -Branch main
```
