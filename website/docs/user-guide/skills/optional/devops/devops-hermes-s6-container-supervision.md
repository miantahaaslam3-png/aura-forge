...
| | |
|---|---|
| Source | Optional — install with `hermes skills install official/devops/auraforge-s6-container-supervision` |
| Path | `optional-skills/devops/auraforge-s6-container-supervision` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux |
