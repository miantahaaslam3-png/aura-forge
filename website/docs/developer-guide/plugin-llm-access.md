...
* Implementation: [`agent/plugin_llm.py`](https://github.com/miantahaaslam3-png/aura-forge/blob/main/agent/plugin_llm.py)
* Tests: [`tests/agent/test_plugin_llm.py`](https://github.com/miantahaaslam3-png/aura-forge/blob/main/tests/agent/test_plugin_llm.py)
