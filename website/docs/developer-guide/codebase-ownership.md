...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `auraforge_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `auraforge_cli/` | [Extending the CLI](extending-the-cli.md) |
...
| Session storage | `auraforge_state.py` | [Session Storage](session-storage.md) |
