...
├── auraforge_state.py           # SQLite session/state database with FTS5
├── auraforge_constants.py       # HERMES_HOME, profile-aware paths
...
│
├── auraforge_cli/               # CLI subcommands and setup
