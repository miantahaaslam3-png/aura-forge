 ...
 *
 * Each entry is a key/value pair that lands in the packaged AuraForge.app's
 ...
 * "Aura Forge wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Aura Forge wants to access Music" when Aura Forge never touches the Music
