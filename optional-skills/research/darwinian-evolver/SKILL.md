...
version: 0.1.0
author: Bihruze (Asahi0x), Aura Forge Agent
license: MIT
...
import upstream classes into Aura Forge itself.
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Aura Forge core.
