...
version: 1.0.1
author: Joe Rinaldi Johnson (joerj123), Aura Forge Agent
license: MIT
...
| Telegram (Aura Forge Agent + all other agents) | Do **not** send an image. Send separate messages — never one combined message. |
