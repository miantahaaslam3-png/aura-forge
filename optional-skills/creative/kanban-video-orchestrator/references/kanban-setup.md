...
the actual `setup.sh` that creates the project workspace, configures Aura Forge
...
PyYAML must be installed in the user's Python (it ships with most Aura Forge
