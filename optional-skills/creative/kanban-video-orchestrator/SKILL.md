...
3. **Generates** a setup script that creates Aura Forge profiles, project workspace, and the initial kanban task
...
For mapping role → which Aura Forge skills + toolsets it loads, see
