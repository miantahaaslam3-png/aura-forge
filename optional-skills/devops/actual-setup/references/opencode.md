...
```
OpenCode DOES use the `provider/model` slash form on the CLI (unlike Aura Forge,
...
`hermes-custom-providers` skill, pitfall 2). Aura Forge hits this because it forwards
