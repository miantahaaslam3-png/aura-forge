...
Then start a new Aura Forge session and drive it (below). The skill works zero-config; a few optional
...
Drive it from a Aura Forge session:
...
- **PII handling.** Dossiers live under the Aura Forge home directory (`0600`, optionally
