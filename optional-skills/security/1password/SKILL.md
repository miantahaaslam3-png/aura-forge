...
version: 1.0.0
author: arceus77-7, enhanced by Aura Forge Agent
license: MIT
...
- `tmux` available for stable authenticated sessions during Aura Forge terminal calls (desktop app flow only)
...
### Service Account (recommended for Aura Forge)
...
## Aura Forge Execution Pattern (desktop app flow)

Aura Forge terminal commands are non-interactive by default and can lose auth context between calls.
