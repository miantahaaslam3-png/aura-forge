...
describe('forceTruecolor', () => {
  ...
  it('respects existing FORCE_COLOR unless Aura Forge truecolor is explicit', async () => {
    await withCleanEnv(
      () => {
  ...
  it('lets explicit Aura Forge truecolor override existing FORCE_COLOR', async () => {
    await withCleanEnv(
      () => {
