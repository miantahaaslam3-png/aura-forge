...
export const DARK_SEEDS: ThemeSeeds = {
  accent: '#FFBF00',
  // The classic Aura Forge navy surfaces are IDENTITY, not derivation drift —
...
// The classic light-mode Aura Forge look was never hand-authored: for years the
...
//
// Anything we can't decide stays dark — the default Aura Forge palette
// is the dark one.
...
export function fromSkin(
  ...
  //    base seeds for this polarity. The base's IDENTITY FILLS (Aura Forge navy
  ...
  // the derived value already carries the identity seeds (e.g. Aura Forge navy).
  const activeRow =
