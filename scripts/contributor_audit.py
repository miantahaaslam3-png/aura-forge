...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Aura Forge\s+(Agent|Audit)$", re.IGNORECASE),
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (auraforge-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "auraforge@nousresearch.com",
    "auraforge-audit@example.com",
    "nousbot@nousresearch.com",
    "auraforge@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "miantahaaslam3-png/aura-forge",
                "--state", "merged",
