#!/usr/bin/env python3
"""Build the Aura Forge Skills Index — a centralized JSON catalog of all skills.
...
`auraforge skills search/install` can use it without hitting the GitHub API.
...
def main():
    print("Building Aura Forge Skills Index...", flush=True)
