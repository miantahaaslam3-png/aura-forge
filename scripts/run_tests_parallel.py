...
#                        nousresearch/auraforge-agent:test image, via
...
def _run_one_file_once(
    ...
    env = os.environ.copy()
    temproot = tempfile.mkdtemp(prefix="auraforge-pytest-tmproot-")
...
def _format_file(file: Path, repo_root: Path) -> str:
    ...
    ``/home/runner/work/auraforge-agent/auraforge-agent/tests/acp/test_auth.py``.
