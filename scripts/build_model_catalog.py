#!/usr/bin/env python3
"""Build the Aura Forge Model Catalog — a centralized JSON manifest of curated models.
...
Aura Forge CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Aura Forge release.
...
``https://auraforge-agent.nousresearch.com/docs/api/model-catalog.json``
"""
...
os.environ.setdefault("HERMES_HOME", os.path.join(os.path.expanduser("~"), ".auraforge"))

from auraforge_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "auraforge-agent repo",
            "docs": "https://auraforge-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Aura Forge '
