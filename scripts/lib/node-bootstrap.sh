...
# The Python side recovers through auraforge_cli/npm_engine.py; the installer path
...
# absent. Used by auraforge_constants.find_hermes_node_executable() and safe
