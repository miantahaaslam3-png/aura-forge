...
DEFAULT_DATASETS = [
    ...
    "miantahaaslam3-png/aura-forge-megascience-sft1",
    "NousResearch/Aura Forge-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Aura Forge-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-auraforge-agent"
]
