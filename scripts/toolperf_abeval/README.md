...
batch (tracker: [#77056](https://github.com/miantahaaslam3-png/aura-forge/issues/77056)).
...
- **Two arms, one variable.** `baseline` and `fixes` runs differ ONLY by
  ...
  Aura Forge home, same model, same tasks, same reps.
...
1. Create a dedicated Aura Forge home with credentials for the models under test:
   ...
   integration at it; no Aura Forge observability plugin needs to be enabled.
