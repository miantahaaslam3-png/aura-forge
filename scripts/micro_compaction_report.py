#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Aura Forge logs.
...
With no LOGFILE, reads ``$HERMES_HOME/logs/agent.log`` (default ~/.auraforge).
...
def default_log() -> Path:
    home = os.environ.get("HERMES_HOME") or str(Path.home() / ".auraforge")
