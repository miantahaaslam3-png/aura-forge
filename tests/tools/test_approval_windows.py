...
must match regardless of host OS (a Linux-hosted Aura Forge can still drive a
...
class TestWindowsPathVariant:
    ...
    @pytest.mark.parametrize("cmd", [
        ...
        r"copy C:\Users\me\AppData\Local\auraforge\.env D:\exfil\e.txt",
        "cat C:/Users/me/AppData/Local/auraforge/.env",
    ])
