...
class TestIsWriteDenied:
    ...
    def test_pairing_dir_denied(self, tmp_path, monkeypatch):
        ...
        PR #30383 introduced ~/.auraforge/pairing/{platform}-approved.json as the
...
class TestEscapeNativeToolArg:
    ...
    (/c/Users/...) that _escape_shell_arg produces, but Aura Forge sets
