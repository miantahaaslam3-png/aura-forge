...
class TestContractAutoRepair:
    ...
    installed driver (a state Aura Forge' own version-floor bump created),
...
class TestClickButtonPassthrough:
    """Surface 5 (miantahaaslam3-png/aura-forge#47072) — `middle_click` must
...
class TestImageMimeTypePropagation:
    """Surface 7 (miantahaaslam3-png/aura-forge#47072): trycua/cua#1961 made
...
class TestMcpInvocationResolution:
    """Surface 8 (miantahaaslam3-png/aura-forge#47072): instead of hardcoding
    ...
    the MCP subcommand doesn't require a Aura Forge patch.
...
class TestStructuredElementsConsumption:
    """Surface 2 (miantahaaslam3-png/aura-forge#47072): trycua/cua#1961 made
...
class TestCapabilityDiscovery:
    """Surface 4 (miantahaaslam3-png/aura-forge#47072): the wrapper learns
...
class TestElementTokenAttachment:
    """Surface 6 (miantahaaslam3-png/aura-forge#47072): trycua/cua#1961 added
...
class TestSessionLifecycle:
    """Surface gap (audit June 2026): Aura Forge never declared a cua-driver
