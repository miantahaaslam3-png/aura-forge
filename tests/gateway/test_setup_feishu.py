"""Tests for _setup_feishu() in auraforge_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("auraforge_cli.config.save_env_value", side_effect=mock_save), \
         patch("auraforge_cli.config.get_env_value", side_effect=mock_get), \
         patch("auraforge_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("auraforge_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("auraforge_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("auraforge_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("auraforge_cli.cli_output.print_header"), \
         patch("auraforge_cli.cli_output.print_info"), \
         patch("auraforge_cli.cli_output.print_success"), \
         patch("auraforge_cli.cli_output.print_warning"), \
         patch("auraforge_cli.cli_output.print_error"), \
