...
class TestDMTopicFallbackReplyToMode:
    ...
    Regression tests for https://github.com/miantahaaslam3-png/aura-forge/issues/23994:
    reply_to_mode 'off' was ignored when sending via Aura Forge-created DM topic
...
class TestDMTopicSyntheticSendRouting:
    ...
    Regression tests for https://github.com/miantahaaslam3-png/aura-forge/issues/87051:
    ...
    response in a different chat lane than the Aura Forge topic the session runs
    in. The no-anchor branch must prefer the Aura Forge topic's
