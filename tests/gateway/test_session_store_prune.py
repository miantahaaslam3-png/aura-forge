...
def test_session_store_default_db_uses_runtime_hermes_home(tmp_path, monkeypatch):
    ...
    auraforge_state before a fixture redirected HERMES_HOME used to pin every
    default SessionDB() at the developer's real ~/.auraforge/state.db.
    """
...
class TestReadmeSentinel:
    ...
    def test_save_writes_readme_sentinel_first(self, tmp_path):
        ...
        assert "auraforge sessions list" in raw["_README"]
