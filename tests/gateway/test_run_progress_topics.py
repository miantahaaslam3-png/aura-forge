...
class LongPreviewAgent:
    ...
    LONG_CMD = "cd /home/teknium/.auraforge/auraforge-agent/.worktrees/auraforge-d8860339 && source .venv/bin/activate && python -m pytest tests/gateway/test_run_progress_topics.py -n0 -q"
...
class UrlPreviewAgent:
    URL = "https://auraforge-agent.nousresearch.com/docs/gateway/discord/tool-progress"
