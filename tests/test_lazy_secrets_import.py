"""Regression test: auraforge update must not load cryptography eagerly."""
...
assert 'auraforge_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running auraforge update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so auraforge_cli is importable,
...
import auraforge_cli.main
from auraforge_cli.update_cmd import _cmd_update_check
