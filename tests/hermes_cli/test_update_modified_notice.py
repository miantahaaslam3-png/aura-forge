"""Guard: every `auraforge update` path that reports user-modified skills must
...
_HINT_RE = re.compile(r"auraforge skills list-modified")
...
def test_every_user_modified_notice_points_at_list_modified():
    ...
    for idx in count_sites:
        ...
        assert _HINT_RE.search(window), (
            ...
            "`auraforge skills list-modified` within the following lines — the "
