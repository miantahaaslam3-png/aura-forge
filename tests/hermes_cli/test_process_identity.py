"""Tests for auraforge_cli.process_identity — spawn tags, the machine spawn
...
def _holders(*pids):
    return [(p, "python.exe", f"python.exe -m auraforge_cli.main --profile p{p} serve") for p in pids]
