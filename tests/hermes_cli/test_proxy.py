"""Tests for the `auraforge proxy` subcommand and its upstream adapters."""
...
from auraforge_cli.proxy.adapters import ADAPTERS, get_adapter
from auraforge_cli.proxy.adapters.base import UpstreamAdapter, UpstreamCredential
from auraforge_cli.proxy.adapters.nous_portal import NousPortalAdapter
from auraforge_cli.proxy.adapters.xai import XAIGrokAdapter
...
def test_nous_adapter_concurrent_refresh_serialized(tmp_path, monkeypatch):
    ...
    with patch(
        "auraforge_cli.proxy.adapters.nous_portal.resolve_nous_runtime_credentials",
...
def test_xai_adapter_retry_rotates_pool_entry_on_429(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("auraforge_cli.auth.refresh_xai_oauth_pure", _refresh_must_not_run)
...
from auraforge_cli.proxy.server import create_app  # noqa: E402
