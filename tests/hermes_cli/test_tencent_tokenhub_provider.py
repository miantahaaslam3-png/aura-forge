...
# =============================================================================
# CANONICAL_PROVIDERS (auraforge model picker)
# =============================================================================
...
class TestTencentTokenhubNormalization:
    ...
    def test_not_in_lowercase_providers(self):
        ...
        from auraforge_cli.model_normalize import _LOWERCASE_MODEL_PROVIDERS
...
class TestTencentTokenhubKnownProviderNames:
    ...
    def test_alias_known(self, alias):
        from auraforge_cli.models import _KNOWN_PROVIDER_NAMES
