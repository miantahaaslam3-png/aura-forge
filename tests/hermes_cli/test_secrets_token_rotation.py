"""Tests for `auraforge secrets bitwarden token` / `auraforge secrets onepassword token`.
...
from auraforge_cli import onepassword_secrets_cli as op_cli
from auraforge_cli import secrets_cli as bw_cli
