"""Regression tests for Desktop-owned ``auraforge serve`` lifecycle tracking."""

from auraforge_cli.web_server import _is_serve_orphaned, _valid_parent_start_marker
