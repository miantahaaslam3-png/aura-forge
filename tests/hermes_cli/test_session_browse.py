"""Tests for the interactive session browser (`auraforge sessions browse`).
...
from auraforge_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """auraforge sessions browse should be parseable."""
