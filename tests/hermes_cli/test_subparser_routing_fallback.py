...
The main() function in auraforge_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `auraforge -c model`
...
def _build_parser():
    """Build a minimal replica of the auraforge top-level parser."""
