"""Tests for auraforge_cli.security_advisories.
...
import auraforge_cli.security_advisories as adv
...
class TestAck:
    ...
    def test_ack_advisory_persists_id(self, isolated_home, monkeypatch):
        ...
        # don't depend on the full auraforge_cli.config bootstrap.
        store: dict = {"security": {}}
        monkeypatch.setattr(
            "auraforge_cli.config.load_config", lambda: store
        )
        monkeypatch.setattr(
