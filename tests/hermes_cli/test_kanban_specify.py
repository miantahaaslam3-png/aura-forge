"""Tests for the specifier module + `auraforge kanban specify` CLI surface.
...
from auraforge_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `auraforge kanban …` argparse surface directly."""
