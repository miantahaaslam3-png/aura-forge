...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and auraforge-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # auraforge-agent (tests/skills/)
]
