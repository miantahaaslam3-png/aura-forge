...
#
# Installs a real, earlier Aura Forge the way a user does, applies ONE update route,
...
# both together.
UPSTREAM_URL="${HERMES_DEV_SANDBOX_UPSTREAM:-https://github.com/miantahaaslam3-png/aura-forge.git}"
...
# ── install the earlier Aura Forge ─────────────────────────────────────────────
