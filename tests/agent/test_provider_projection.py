...
calls never come back as pending ``tool_calls`` (Aura Forge would re-run finished
work), so two subsystems would otherwise be blind to them:
  ...
  * the skill-review nudge, whose counter only moves on Aura Forge tool iterations.
