"""Session <-> workspace grouping key (auraforge_state.workspace_key).

The key is what `auraforge sessions list --workspace` groups/filters on. It is a
...
from auraforge_state import workspace_key
