...
The unit tests in tests/auraforge_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned auraforge-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/auraforge")
from auraforge_cli.service_manager import S6ServiceManager
