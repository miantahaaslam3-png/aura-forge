...
from auraforge_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/auraforge_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("auraforge_cli.lifecycle.invoke_hook")
@patch("auraforge_cli.lifecycle.finalize_session")
...
@patch("auraforge_cli.plugins.invoke_hook")
