...
binary download are exercised manually by `auraforge secrets bitwarden
...
def hermes_home(tmp_path, monkeypatch):
    """Point Aura Forge at an isolated home directory."""
    ...
    if hasattr(auraforge_constants, "_HERMES_HOME_CACHE"):
        auraforge_constants._HERMES_HOME_CACHE = None  # type: ignore[attr-defined]
    return home
...
def test_env_loader_calls_bsm_when_enabled(tmp_path, monkeypatch):
    ...
    from auraforge_cli.env_loader import _apply_external_secret_sources
