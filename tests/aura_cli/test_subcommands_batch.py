...
from aura_cli.subcommands.auth import build_auth_parser
from aura_cli.subcommands.backup import build_backup_parser
from aura_cli.subcommands.config import build_config_parser
from aura_cli.subcommands.dashboard import build_dashboard_parser
from aura_cli.subcommands.debug import build_debug_parser
from aura_cli.subcommands.doctor import build_doctor_parser
from aura_cli.subcommands.dump import build_dump_parser
from aura_cli.subcommands.gui import build_gui_parser
from aura_cli.subcommands.hooks import build_hooks_parser
from aura_cli.subcommands.import_cmd import build_import_cmd_parser
from aura_cli.subcommands.login import build_login_parser
from aura_cli.subcommands.logout import build_logout_parser
from aura_cli.subcommands.logs import build_logs_parser
from aura_cli.subcommands.model import build_model_parser
from aura_cli.subcommands.postinstall import build_postinstall_parser
from aura_cli.subcommands.prompt_size import build_prompt_size_parser
from aura_cli.subcommands.security import build_security_parser
from aura_cli.subcommands.setup import build_setup_parser
from aura_cli.subcommands.slack import build_slack_parser
from aura_cli.subcommands.status import build_status_parser
from aura_cli.subcommands.uninstall import build_uninstall_parser
from aura_cli.subcommands.update import build_update_parser
from aura_cli.subcommands.version import build_version_parser
from aura_cli.subcommands.webhook import build_webhook_parser
from aura_cli.subcommands.whatsapp import build_whatsapp_parser
...
# ── deprecated `aura login` fails gracefully, not with argparse error ────
#
# `aura login` is a removed command; its handler (`login_command` in
# `aura_cli/auth.py`) prints a deprecation notice pointing at `aura auth` /
# `aura model` and exits 0.  Two behavior contracts guard the UX:
...
def test_login_subparser_help_is_suppressed():
    """The deprecated `login` row must not appear in `aura --help`.
