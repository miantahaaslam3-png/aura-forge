"""Tests for the interactive session browser (`aura sessions browse`).
...
from aura_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """aura sessions browse should be parseable."""
