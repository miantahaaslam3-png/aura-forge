...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from aura_cli.model_normalize import _VENDOR_PREFIXES
    ...
    def test_lowercase_subset_of_matching_prefix(self):
        ...
        """
        from aura_cli.model_normalize import (
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in AURA_OVERLAYS
        overlay = AURA_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify aura doctor recognizes Xiaomi env vars."""
