...
The main() function in aura_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `aura -c model`
...
def _build_parser():
    """Build a minimal replica of the aura top-level parser."""
