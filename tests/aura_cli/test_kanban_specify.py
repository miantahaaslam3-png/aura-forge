"""Tests for the specifier module + `aura kanban specify` CLI surface.
...
from aura_cli import kanban as kanban_cli
from aura_cli import kanban_db as kb
from aura_cli import kanban_specify as spec
...
def _run_cli(*argv: str) -> int:
    """Invoke the `aura kanban …` argparse surface directly."""
