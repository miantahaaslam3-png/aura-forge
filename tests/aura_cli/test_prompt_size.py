"""Tests for the ``aura prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from aura_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(aura_home, memory_text="", user_text=""):
    mem_dir = aura_home / "memories"
...
def _seed_skill(aura_home, name, description):
    skill_dir = aura_home / "skills" / "demo" / name
