"""Tests for aura_cli.kanban_diagnostics — rule-engine that produces
...
from aura_cli import kanban_diagnostics as kd
...
def test_triage_aux_unavailable_fires_auto_decompose_off_points_at_specifier():
    ...
    assert any("aura kanban specify" in l for l in labels)
