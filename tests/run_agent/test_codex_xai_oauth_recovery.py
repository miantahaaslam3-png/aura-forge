...
3. Multi-turn replay of ``codex_reasoning_items`` (with
   ...
   reverted shortly after: xAI confirmed they explicitly want Aura Forge to
...
def test_codex_reasoning_replay_includes_encrypted_content_for_xai():
    ...
    want Aura Forge to thread encrypted reasoning back across turns for
...
def test_grok_4_3_context_length_is_1m():
    ...
    Aura Forge' substring-match fallback used to return 256k (from the
...
def test_transport_round_trip_drops_foreign_reasoning():
    ...
    messages = [
        {"role": "system", "content": "you are auraforge"},
        {"role": "user", "content": "hi"},
    ...
    kwargs = transport.build_kwargs(
        ...
        instructions="you are auraforge",
    )
