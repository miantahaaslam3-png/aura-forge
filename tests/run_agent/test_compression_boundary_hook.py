...
old_session_id=<old>). This lets plugin engines (e.g. auraforge-lcm) preserve
DAG lineage across the split instead of treating it as a fresh /new.

See auraforge-lcm#68: after Aura Forge compresses and mints a new physical session,
