...
class ShellFileOperations(FileOperations):
    ...
    def _escape_native_tool_arg(self, arg: str) -> str:
        ...
        paths — and Aura Forge disables MSYS argument conversion for its bash
    ...
    def _atomic_write(self, path: str, content: str) -> "ExecuteResult":
        ...
        ``.auraforge-tmp`` file next to the user's data, and the original file
        ...
        tmpl = self._escape_shell_arg(".auraforge-tmp.XXXXXX")
        ...
        script = (
            ...
            '|| mktemp "$d/.auraforge-tmp.$$.XXXXXX" 2>/dev/null '
            '|| { tmp="$d/.auraforge-tmp.$$"; : > "$tmp" && echo "$tmp"; })"; '
    ...
    def write_file(self, path: str, content: str,
        ...
        # clean the temp up on any failure so we never leak a ``.auraforge-tmp``
    ...
    def _search_with_rg(self, pattern: str, path: str, file_glob: Optional[str],
        ...
        # nothing converts back — Aura Forge sets MSYS_NO_PATHCONV for its bash).
