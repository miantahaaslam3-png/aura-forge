...
def _base_subprocess_env() -> dict:
    ...
    # may differ from Aura Forge's venv Python. PYTHONPATH/PYTHONHOME inherited
    # from the agent process point at Aura Forge's venv site-packages, and a
    ...
    # needs Aura Forge's import path.
