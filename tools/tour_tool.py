#!/usr/bin/env python3
"""Run a guided tour (highlight + narrate UI elements) in the Aura Forge desktop GUI.
...
- ``surface="app"`` — the Aura Forge desktop app's own DOM (tours of Aura Forge itself).
...
def tour_tool(
    ...
    if callback is None:
        return tool_error("tour is only available in the Aura Forge desktop app.")
...
TOUR_SCHEMA = {
    ...
    "description": (
        ...
        "element, attach a titled popover. Surfaces: 'app' (Aura Forge itself) "
