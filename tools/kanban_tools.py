...
def _connect(board: Optional[str] = None):
    ...
    the env-pinned active board without restarting Aura Forge.
    """
...
def _handle_attach_url(args: dict, **kw) -> str:
    ...
    The agent passes a URL; Aura Forge downloads it (with the shared size cap)
...
KANBAN_ATTACH_URL_SCHEMA = {
    ...
    "description": (
        "Attach a file to a task by URL — Aura Forge downloads it server-side "
