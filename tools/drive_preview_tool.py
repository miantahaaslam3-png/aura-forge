#!/usr/bin/env python3
"""Interact with the in-app browser / preview pane in the Aura Forge desktop GUI.
...
def drive_preview_tool(
    ...
    if callback is None:
        return tool_error("drive_preview is only available in the Aura Forge desktop app.")
