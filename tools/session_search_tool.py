...
the get_anchored_view / get_messages_around primitives in auraforge_state.
...
from auraforge_state_common import _RESET_END_REASONS
...
SESSION_SEARCH_SCHEMA = {
    "name": "session_search",
    "description": (
        "Search past Aura Forge sessions (FTS5 over the local session DB), or read/"
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Aura Forge profile's database "
