...
Trust levels:
  - builtin:   Ships with Aura Forge. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    #     For Aura Forge/other config files it is high (caution) — legitimate
    ...
    (_prose_modify_re(_HERMES_CONFIG_FILES),
     ...
     "modification language aimed at Aura Forge configuration files (verify intent)"),
