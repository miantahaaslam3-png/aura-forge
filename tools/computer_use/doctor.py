...
flow through here without code changes on the Aura Forge side — the only
...
def _sanitized_cua_env() -> Dict[str, str]:
    """Telemetry-policy env with Aura Forge provider secrets stripped.
...
def run_doctor(
    ...
    *,
    ...
    if json_output:
        ...
        # attach Aura Forge identity under hermes_identity so existing parsers
