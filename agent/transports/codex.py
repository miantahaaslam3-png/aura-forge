...
# Wire-name used when Aura Forge keeps client-side web_search on xAI Responses.
...
# avoids that while still dispatching through Aura Forge's configured provider
...
# Aura Forge dispatch is unaffected.
...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # xAI server-side web search vs Aura Forge web providers.
        #
        ...
        #    keep Aura Forge dispatch so ``web.backend`` / ``web.search_backend``
    ...
    def normalize_response(self, response: Any, **kwargs) -> NormalizedResponse:
        ...
        if msg and msg.tool_calls:
            ...
            for tc in msg.tool_calls:
                ...
                # Undo the xAI client-path wire alias so Aura Forge dispatches
