...
decomposition campaign (``~/.auraforge/plans/god-file-decomposition.md``, Phase 1
...
def finalize_turn(
    ...
    *,
    ...
    result = {
        ...
        # billing audits by callers like `auraforge -z --usage-file`.
        "service_tier": (
    ...
    if failed and str(_turn_exit_reason) == "session_persistence_failed":
        result["error"] = final_response or (
            ...
            "health (`auraforge doctor`), then send your message again"
        )
