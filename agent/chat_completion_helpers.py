...
from auraforge_cli.timeouts import get_provider_request_timeout, get_provider_stale_timeout
from auraforge_constants import PARTIAL_STREAM_STUB_ID, FINISH_REASON_LENGTH
...
def handle_max_iterations(agent, messages: list, api_call_count: int) -> str:
    ...
    try:
        ...
        for msg in messages:
            ...
            # substitute it before dropping the key (Aura Forge bookkeeping,
...
def interruptible_streaming_api_call(agent, api_kwargs: dict, *, on_first_delta=None):
    ...
    def _call_chat_completions(stream_attempt_id: int):
        ...
        def _accept_stream_chunk(_chunk: Any) -> bool:
            ...
            # already-received tool-call chunk back to Aura Forge. Preserve only
        ...
        if agent.provider == "moa":
            # Aura Forge interrupts the managed stream; Relay retains sole
        ...
        # completed response. Relay records that attempt while Aura Forge preserves
