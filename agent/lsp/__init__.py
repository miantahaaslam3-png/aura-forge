"""Language Server Protocol (LSP) integration for Aura Forge Agent.

Aura Forge runs full language servers (pyright, gopls, rust-analyzer,
...
def get_service() -> Optional[LSPService]:
    ...
    with _service_lock:
        ...
        if not _atexit_registered:
            ...
            # ``auraforge chat`` exit would leak pyright processes that
