...
_OFFICIAL_DOCS_PRICING: Dict[tuple[str, str], PricingEntry] = {
    ...
    # Fireworks AI — serverless pricing for the models auraforge typically routes
...
# onto the base entries so the snapshot stays single-source. The Aura Forge-side
