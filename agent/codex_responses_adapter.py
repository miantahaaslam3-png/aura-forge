...
# output items.  Aura Forge injects xAI's native ``web_search`` for the xAI
...
def _chat_messages_to_responses_input(
    ...
    *,
    ...
    explicitly relies on Aura Forge threading encrypted reasoning back across
    ...
    ``convert_messages``). Dropping the checkpoint costs nothing: Aura Forge'
...
def _normalize_codex_response(
    ...
    *,
    ...
    if tool_calls:
        ...
        # See https://github.com/miantahaaslam3-png/aura-forge/issues/64434
