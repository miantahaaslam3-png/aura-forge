"""Vertex AI (Google Cloud) adapter for Aura Forge Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Aura Forge to use Gemini models via Google Cloud with
...
def has_explicit_vertex_config() -> bool:
    """True only when the user deliberately pointed Aura Forge at Vertex.
