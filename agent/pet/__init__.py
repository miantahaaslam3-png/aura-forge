...
an 8-column × 9-row atlas; older Aura Forge/petdex sheets used an 8-row atlas.
Aura Forge infers the row taxonomy from the sheet and maps agent activity onto
