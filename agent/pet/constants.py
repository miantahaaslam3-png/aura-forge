...
row taxonomy is inferred from the atlas shape so Aura Forge can render both legacy
...
# rows (1536x1872), while older Aura Forge/petdex sheets used 9 columns x 8 rows
...
# Legacy Aura Forge/petdex row order (top -> bottom) used by the older 8-row,
...
# Canonical Aura Forge activity names -> accepted row-name aliases in descending
