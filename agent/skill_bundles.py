...
Storage
-------
Bundles live in ``~/.auraforge/skill-bundles/*.yaml`` (and the equivalent
...
- :func:`list_bundles` — return rich info for display (``auraforge bundles``)
...
# ---------------------------------------------------------------------------
# File-level CRUD helpers — used by `auraforge bundles` CLI subcommand.
# ---------------------------------------------------------------------------
