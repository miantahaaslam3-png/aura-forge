...
# ``data:`` field before Aura Forge receives a completion chunk.  Keeping this
...
# See: https://github.com/miantahaaslam3-png/aura-forge/issues/69078
...
#
# See: https://github.com/miantahaaslam3-png/aura-forge/issues/27344
...
# case: a stream dies mid-response and Aura Forge persists a content-less
...
# Request parameters that Aura Forge sends on SOME routes only, paired with the
...
def classify_api_error(
    ...
    *,
    ...
    # auraforge_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from auraforge_cli.plugins import get_plugin_error_classification
