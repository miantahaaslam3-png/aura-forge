...
def dump_api_request_debug(
    ...
    *,
    ...
    try:
        ...
        # originate from untrusted input (X-Aura Forge-Session-Id header), and an
...
def anthropic_prompt_cache_policy(
    ...
    *,
    ...
    # that are canonicalized only after Aura Forge sends the request. Honor its
...
def create_openai_client(agent, client_kwargs: dict, *, reason: str, shared: bool) -> Any:
    ...
    # Delegate all rate-limit / 5xx retry to auraforge's outer conversation loop,
    ...
    # All primary construction and recovery paths must identify Aura Forge to the
...
def sanitize_api_messages(messages: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    #
    # We do NOT drop the call: auraforge' own dispatch loop intentionally keeps an
...
def _iter_httpx_pool_objects(http_client: Any):
    ...
    Aura Forge' keepalive client (#10324 / ``_build_keepalive_http_client``) and
