...
Optional hooks (override to opt in):
  ...
  backup_paths() -> list[str]            — extra on-disk paths to include in `auraforge backup`
"""
...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - hermes_home (str): The active HERMES_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.auraforge``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "auraforge").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'auraforge memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], hermes_home: str) -> None:
        ...
        Called by 'auraforge memory setup' after collecting user inputs.
    ...
    def backup_paths(self) -> List[str]:
        ...
        ``auraforge backup`` only walks HERMES_HOME, so any provider state kept
        ...
        of the archive, and ``auraforge import`` restores them to their original
