...
def _getenv(name: str, default: str = "") -> str:
    ...
    read) when on. Mirrors the same wrapper in auraforge_cli/runtime_provider.py.
    """
...
def resolve_anthropic_token() -> Optional[str]:
    ...
    # 5. Aura Forge credential_pool OAuth entry.
...
def run_hermes_oauth_login_pure() -> Optional[Dict[str, Any]]:
    ...
    try:
        from auraforge_cli.auth import _can_open_graphical_browser as _can_open_gui
    except Exception:
