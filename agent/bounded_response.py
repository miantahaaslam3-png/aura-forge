...
When a provider returns a non-OK status on a *streaming* request, Aura Forge reads
...
streams"), generalized to cover Aura Forge's three streaming error-body sites
