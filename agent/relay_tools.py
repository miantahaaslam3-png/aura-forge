"""Core NeMo Relay adapter for Aura Forge tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Aura Forge tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Aura Forge Relay tool execution cannot run on an active event-loop thread"
    )
