...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    AIAgent.  Aura Forge never re-renders parts of this string mid-
    ...
    # Pointer to the hermes-agent skill + docs for user questions about Aura Forge itself.
    ...
    # Coding posture (base Aura Forge, any interactive coding surface in a code
    ...
    if active_profile == "default":
        ...
        stable_parts.append(
            f"Active Aura Forge profile: {active_profile}. This session reads "
...
def build_system_prompt(agent: Any, system_message: Optional[str] = None) -> str:
    ...
    one cached block — Aura Forge never rebuilds or reinjects parts of it
