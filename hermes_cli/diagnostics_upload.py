"""Client for uploading ``auraforge debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``auraforge debug share``.
...
_USER_AGENT = "aura-forge-agent/debug-share"
