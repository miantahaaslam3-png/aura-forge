...
class CLICommandsMixin:
    ...
    def _handle_update_command(self) -> bool:
        """Handle /update — update Aura Forge to the latest version.
        ...
        if is_managed():
            print(f"  ✗ {format_managed_message('update Aura Forge')}")
            return False
        ...
        choices = [
            ("once", "Update Now", "exit the current session and update Aura Forge"),
