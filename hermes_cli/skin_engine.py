"""Aura Forge CLI skin/theme engine.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Aura Forge"          # Banner title, status display
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Aura Forge"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "Aura Forge",
            "welcome": "Welcome to Aura Forge! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
