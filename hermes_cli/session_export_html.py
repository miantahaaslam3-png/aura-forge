"""
HTML Export generator for Aura Forge sessions.
...
<body>
    <div class="layout {layout_class}">
        ...
        <div class="main-content">
            ...
            <footer>
                Built with ☤ Aura Forge Agent • Generated on {generated_at}
            </footer>
        </div>
    </div>
...
def generate_multi_session_html_export(sessions: List[Dict[str, Any]]) -> str:
        ...
        <aside class="sidebar">
            <div class="sidebar-header">
                <div class="sidebar-brand">
                    {ICON_HERMES} Aura Forge History
                </div>
    ...
    for s in sessions:
        sid = str(s.get("id", "N/A"))
        escaped_sid = _escape_html(sid)
        title = s.get("title") or "Aura Forge Session"
    ...
    return HTML_TEMPLATE.format(
        page_title="Aura Forge Session Export" if is_multi else _escape_html(sessions[0].get("title") or "Aura Forge Session"),
