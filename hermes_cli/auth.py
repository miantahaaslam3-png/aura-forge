...
PROVIDER_REGISTRY: Dict[str, ProviderConfig] = {
    # Nous Portal disabled in Aura Forge
    # "nous": ProviderConfig(
    #     id="nous",
    #     name="Nous Portal",
...
def login_command(args) -> None:
    ...
    print("The 'aura login' command has been removed.")
    print("Use 'aura auth' to manage credentials,")
...
def _login_nous(args, pconfig: ProviderConfig) -> None:
    """Nous Portal device authorization flow - DISABLED in Aura Forge."""
    print("Nous Portal integration is not available in Aura Forge.")
    print("Use API keys or other providers instead.")
    raise SystemExit(1)
