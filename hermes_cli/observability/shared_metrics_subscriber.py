"""Relay subscriber for the persisted Aura Forge shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Aura Forge counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Aura Forge shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
