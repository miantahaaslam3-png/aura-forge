...
app = FastAPI(title="Aura Forge", version=__version__, lifespan=_lifespan)
...
_TELEGRAM_ONBOARDING_USER_AGENT = f"AuraForgeDashboard/{__version__}"
...
async def start_telegram_onboarding(body: TelegramOnboardingStart):
    bot_name = (body.bot_name or "Aura Forge").strip() or "Aura Forge"
...
def _anthropic_oauth_status() -> Dict[str, Any]:
    ...
    if hermes_creds and hermes_creds.get("accessToken"):
        return {
            "logged_in": True,
            "source": "hermes_pkce",
            "source_label": f"Aura Forge PKCE ({_HERMES_OAUTH_FILE})",
...
_BUILTIN_DASHBOARD_THEMES = [
    {"name": "default",       "label": "Aura Forge Teal",         "description": "Classic dark teal — the classic Aura Forge look"},
    ...
    if app.state.auth_required:
        ...
        if not list_providers():
            ...
            _fix_hint = (
                ...
                "  • OAuth: run `aura dashboard register` (Nous Portal) or "
