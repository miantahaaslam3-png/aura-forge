...
version: 4.0.0
author: 0xbyt4, Aura Forge Agent
license: MIT
dependencies: []
...
```bash
python -m pyfiglet "AURA FORGE" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=AURA%20FORGE&font=Slant" | boxes -d stone
```
