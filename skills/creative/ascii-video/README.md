...
Built for [Aura Forge Agent](https://github.com/miantahaaslam3-png/aura-forge). Usable in any coding agent. Canonical source lives here; synced to [`miantahaaslam3-png/aura-forge/skills/creative/ascii-video`](https://github.com/miantahaaslam3-png/aura-forge/tree/main/skills/creative/ascii-video) via PR.
