...
Registry of record: `auraforge_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Aura Forge config+state snapshots (CLI)
...
/update                  Update Aura Forge to latest
