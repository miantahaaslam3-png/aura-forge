...
- **Self-improving through skills** — Aura Forge learns from experience by saving reusable procedures as skills that load into future sessions.
...
This skill is a concise operating guide, not the complete source of truth for every Aura Forge feature. If a Aura Forge feature, command, or setting is not mentioned here or in a reference, do not treat that absence as evidence that it does not exist. Check the live repository and official docs before giving a negative answer.
...
- CLI commands: `auraforge --help`, `auraforge <command> --help`, and `auraforge_cli/main.py`
