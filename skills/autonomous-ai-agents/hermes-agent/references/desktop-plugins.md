...
Write plugins for the Aura Forge desktop app: statusbar items, layout panes,
...
- `ctx.os` — the curated OS door, attributed to your plugin:
  ...
  posts a native OS notification. Fires only while the user is away from Aura Forge
