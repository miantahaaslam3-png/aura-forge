...
Aura Forge Agent (see website/docs/getting-started/platform-support.md). The
...
Aura Forge package derivation, so only that build may create an artifact.
...
_BLOCK_MESSAGE = (
    ...
    "the Aura Forge Nix derivation sets HERMES_NIX_BUILD=1. If it does, file a bug."
)
