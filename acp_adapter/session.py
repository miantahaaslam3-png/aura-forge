...
def _normalize_cwd_for_compare(cwd: str | None) -> str:
    ...
    from auraforge_constants import windows_path_to_wsl
...
def _register_task_cwd(task_id: str, cwd: str) -> None:
    ...
    Zed can launch Aura Forge from a Windows workspace while the ACP process runs
...
@dataclass
class SessionState:
    """Tracks per-session state for an ACP-managed Aura Forge agent."""
...
class SessionManager:
    """Thread-safe manager for ACP sessions backed by Aura Forge AIAgent instances.
    ...
    def _restore(self, session_id: str) -> Optional[SessionState]:
        ...
        # for the rest of the session (see auraforge_state.get_messages_as_conversation).
        try:
    ...
    def _make_agent(
        ...
        *,
        ...
        # editor/session cwd instead of the Aura Forge daemon's process cwd.
