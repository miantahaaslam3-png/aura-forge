"""ACP tool-call helpers for mapping aura tools to ACP ToolKind and building content."""
...
# ---------------------------------------------------------------------------
# Map aura tool names -> ACP ToolKind
# ---------------------------------------------------------------------------
...
def get_tool_kind(tool_name: str) -> ToolKind:
    """Return the ACP ToolKind for a aura tool, defaulting to 'other'."""
...
def build_tool_start(
    ...
    *,
    ...
    """Create a ToolCallStart event for the given aura tool invocation."""
