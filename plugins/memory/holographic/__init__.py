"""auraforge-memory-store — holographic memory plugin using MemoryProvider interface.
...
class HolographicMemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, hermes_home):
        """Write config to config.yaml under plugins.auraforge-memory-store."""
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        # "$HERMES_HOME/memory_store.db" or "~/.auraforge/memory_store.db" both
