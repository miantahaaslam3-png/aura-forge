...
from auraforge_cli.profiles import _get_default_hermes_home
...
def profile_host_key(profile: str | None) -> str:
    """Return the safe Honcho host key for a Aura Forge profile."""
...
def resolve_active_host() -> str:
    ...
    # but applying it before profile resolution makes every named Aura Forge
    # profile share that same host.  Keep named profiles isolated; only the
    # default Aura Forge profile may opt into the config's default host.
