...
_DEFAULT_CONTAINER_TAG = "auraforge"
...
_API_KEY_URL = "http://app.supermemory.ai/integrations?connect=auraforge"
...
class _SupermemoryClient:
    def __init__(self, api_key: str, timeout: float, container_tag: str,
        ...
        self._client = Supermemory(
            ...
            timeout=timeout,
            max_retries=0,
            default_headers={"x-sm-source": "auraforge"},
        )
    ...
    def _merge_metadata(self, metadata: Optional[dict]) -> dict:
        ...
        merged = {"sm_source": "auraforge", **(metadata or {})}
...
class SupermemoryMemoryProvider(MemoryProvider):
    ...
    def get_config_schema(self):
        # Only prompt for the API key during `auraforge memory setup`.
    ...
    def post_setup(self, hermes_home: str, config: dict) -> None:
        ...
        from auraforge_cli.memory_setup import _prompt, _write_env_vars
