...
Behavioral settings (live in $HERMES_HOME/mem0.json, set via `auraforge memory
setup`):
  ...
  agent_id           — Agent identifier (default: auraforge)
...
_DEFAULT_USER_ID = "auraforge-user"
...
def _load_config() -> dict:
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "auraforge"),
        "oss": {},
    }
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._agent_id = self._config.get("agent_id", "auraforge")
