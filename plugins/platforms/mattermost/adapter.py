...
required — uses aiohttp which is already a Aura Forge dependency.
...
def interactive_setup() -> None:
    ...
    ``auraforge_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Aura Forge delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # auraforge_cli/setup.py::_setup_mattermost function.
