...
try:
    from auraforge_constants import display_hermes_home, get_hermes_home
except (ModuleNotFoundError, ImportError):
    # Fallback for environments where auraforge_constants isn't importable
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Google Chat user-OAuth setup for Aura Forge (native attachment delivery)"
    )
