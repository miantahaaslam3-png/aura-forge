...
- **Inbound attachments and voice notes are downloaded.** The sidecar reads
  ...
  something arrived. If Spectrum emits a `richlink` content object, Aura Forge
  ...
  `.pluginPayloadAttachment` images immediately after the URL; Aura Forge coalesces
...
- **Native polls are supported.** Aura Forge posts poll content through
