...
class TelegramAdapter(BasePlatformAdapter):
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        # has been killed (e.g. during `aura update` or `--replace` handoffs)
        ...
        message = (
            ...
            "with this token, then restart the gateway with 'aura gateway restart'."
    ...
    def _build_provider_keyboard(self, providers: list):
        ...
        CLI ``aura model`` picker via the shared ``group_providers`` fold,
