"""
A2A (Agent-to-Agent) plugin for Aura Forge Agent.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes Aura Forge as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    ...
    print_info("Expose Aura Forge as an A2A-discoverable agent and call other A2A agents.")
