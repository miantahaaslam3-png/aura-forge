# A2A — Agent-to-Agent protocol for Aura Forge
...
peer (another Aura Forge, LangChain, CrewAI, Google ADK, OpenClaw, …). Stdlib only —
...
When the `a2a` platform is enabled, Aura Forge serves a v1.0 Agent Card at
