...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Aura Forge gateway adapter.

    Each inbound phone number gets its own Aura Forge session (multi-tenant).
...
# static dict in auraforge_cli/gateway.py, and the _send_sms dispatch in
