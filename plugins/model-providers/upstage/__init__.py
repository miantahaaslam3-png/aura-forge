...
# When the user hasn't picked a reasoning effort, Aura Forge passes
...
# ON at this effort — matching the "medium (default)" that Aura Forge' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Aura Forge' effort vocabulary onto Solar's accepted set via the
