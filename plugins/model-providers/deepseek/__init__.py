...
the contract that subsequent turns echo it back; combined with how Aura Forge
...
2026-07-24.  Use ``deepseek-v4-flash`` or ``deepseek-v4-pro``; Aura Forge remaps
the retired IDs in ``auraforge_cli.model_normalize``.
"""
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    before requests leave Aura Forge, so they are not listed here.
    """
