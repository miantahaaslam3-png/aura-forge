...
request omits ``thinking``.  Aura Forge' ``reasoning_config = {"enabled": False}``
...
:meth:`ZaiProfile.build_api_kwargs_extras` translates the Aura Forge reasoning
...
(per Z.AI / BigModel docs).  Aura Forge' richer effort scale is collapsed onto
...
def _glm_5_2_reasoning_effort(
    ...
    """Map Aura Forge reasoning effort onto GLM's native vocabulary.
