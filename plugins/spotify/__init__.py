...
``_check_spotify_available()`` — when the user has not run ``auraforge auth
spotify``, the tools remain registered (so they appear in ``auraforge
...
The Spotify auth flow (``auraforge auth spotify``), CLI plumbing, and docs
