 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `auraforge_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Aura Forge Teal",
  description: "Classic dark teal — the canonical Aura Forge look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Aura Forge Teal (Large)",
  description: "Aura Forge Teal with bigger fonts and roomier spacing",
