 ...
 *          ▼                                                              .
 *     FastAPI pty_ws  (auraforge_cli/web_server.py)                          .
 *          ▼                                                              .
...
export default function ChatPage({ isActive = true }: { isActive?: boolean }) {
  ...
  useEffect(() => {
    ...
    const term = new Terminal({
      ...
      // even when the inner Aura Forge TUI has enabled xterm mouse-events
    ...
    // forwarding them into Aura Forge. Keyboard input, paste, and resize still
    // behave normally.
