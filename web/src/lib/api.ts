...
const SESSION_HEADER = "X-AuraForge-Session-Token";
 ...
 *
 * The dashboard's gated-mode WS auth (``auraforge_cli.web_server._ws_auth_ok``)
 ...
 *  - loopback / ``--insecure``: attach the ``X-AuraForge-Session-Token`` header.
