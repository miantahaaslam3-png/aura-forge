 ...
 *
 * Values mirror auraforge_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Aura Forge default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Aura Forge' default when unset). */
