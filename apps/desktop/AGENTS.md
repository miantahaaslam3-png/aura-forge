...
How to build Aura Forge Desktop well. This is a judgment guide, not an inventory —
...
- The **backend** is authoritative for anything another Aura Forge surface can also
...
its shape. "Plugin" means several unrelated things across Aura Forge — do not assume
