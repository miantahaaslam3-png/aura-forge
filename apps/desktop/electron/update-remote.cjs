 ...
 *
 * A public install can end up with `origin=git@github.com:miantahaaslam3-png/aura-forge.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/miantahaaslam3-png/aura-forge.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/miantahaaslam3-png/aura-forge'
