...
// Desktop never wrote its first-run bootstrap marker (for example when Aura Forge
// was installed by the CLI first, or when a past desktop build forgot the
// marker). Runtime usability is authoritative for "can we launch local Aura Forge
