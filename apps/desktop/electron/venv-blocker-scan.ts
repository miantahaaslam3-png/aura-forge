...
const SCAN_MODULE = 'auraforge_cli._scan_venv_blockers'
...
export function formatBlockerMessage(result: VenvBlockerScanResult): string {
  const lines = [
    'Update aborted: another Aura Forge process is using this installation.',
    '',
...
export function formatProbeFailedMessage(): string {
  return (
    'Update aborted: Desktop could not verify the Aura Forge installation is free.\n' +
    '\n' +
    'Close other Aura Forge windows and terminals, then retry.  If the problem\n' +
