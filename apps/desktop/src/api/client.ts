...
// "Timed out connecting to Aura Forge backend" that hangs the UI (#48504).
//
...
export class HermesGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'Aura Forge gateway connection closed',
      connectErrorMessage: 'Could not connect to Aura Forge gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'Aura Forge gateway is not connected',
