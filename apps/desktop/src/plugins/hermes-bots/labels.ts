...
export function displayName(bot: Partial<RosterRow>, meta?: BotMeta | null): string {
  ...
  // "Aura Forge". Annotated active rows carry sourceScoped too, and keying this
  ...
  // never generic "Aura Forge" or a hostname-derived label.
  if (alias) {
  ...
  // that reads like nobody bothered. Present it as Aura Forge (the agent it is)
