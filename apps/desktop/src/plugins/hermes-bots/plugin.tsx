/**
 * Aura Forge Bot Mode — a "one chat per agent" roster for the Aura Forge desktop.
 *
 * Left pane "Bots": one row per Aura Forge profile (a bot = an agent profile) with
 ...
 *
 * Right tile "Routines": scheduled tasks (Aura Forge cron jobs) scoped to the
...
export default {
  ...
  register(ctx: PluginContext) {
    ...
    // A bot's chat before it has spoken: core's splash is Aura Forge' wordmark and
