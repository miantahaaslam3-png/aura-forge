...
//      in auraforge_cli/provider_catalog.py) — the SAME provider identity
...
function ConnectedProviderRow({
  ...
  // Aura Forge can clear this provider's creds via the API.
  const canDisconnect = provider.disconnectable ?? provider.flow !== 'external'
  // External (CLI-managed) provider Aura Forge can't clear via the API, but ships a
...
export function ProvidersSettings({
  ...
  // Aura Forge never deletes creds another tool owns behind a silent API call.
