...
/** Why a known Aura Forge command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Aura Forge profile', surface: action('profile') },
  {
    name: '/skin',
 ...
 * Aura Forge' built-in slash commands — i.e. skill commands (`/gif-search`,
 ...
 * activity — the ones that ship with Aura Forge and were never asked for. It is
