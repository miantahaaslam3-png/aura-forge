...
//
// When someone is in a hands-free "Hey Aura Forge" voice chat, the natural way to
...
// phrase (optionally addressed to Aura Forge), so a real turn that merely contains
 ...
 * to Aura Forge). Returns false for anything that merely contains "stop" as part of
