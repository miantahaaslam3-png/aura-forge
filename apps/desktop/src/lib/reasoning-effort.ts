...
/** Aura Forge' reasoning levels, in ascending order — mirrors the backend's
 *  VALID_REASONING_EFFORTS (auraforge_constants.py). `none` is not a level: it's
...
/** Aura Forge' built-in level when neither the surface nor the profile config
