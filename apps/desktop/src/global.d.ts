...
declare global {
  interface Window {
    hermesDesktop: {
      ...
      // Aura Forge Cloud: one portal login powers discovery + silent per-agent
...
export interface DesktopConnectionConfig {
  envOverride: boolean
  // The saved connection mode. 'cloud' is a Aura Forge Cloud connection: it carries
  ...
  remoteUrl: string
  // For a 'cloud' connection: the persisted Aura Forge Cloud org (slug or id) the
...
export interface DesktopConnectionConfigInput {
  ...
  remoteUrl?: string
  // For a 'cloud' connection: the selected Aura Forge Cloud org (slug or id) to
...
// A discovered Aura Forge Cloud agent — the trimmed DTO from NAS GET /api/agents.
