...
export const en: Translations = {
  ...
  boot: {
    ready: 'Aura Forge Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Aura Forge settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Aura Forge backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Aura Forge Desktop…'
    },
    errors: {
      backgroundExited: 'Aura Forge background process exited.',
      backgroundExitedDuringStartup: 'Aura Forge background process exited during startup.',
    ...
    failure: {
      title: "Aura Forge couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Aura Forge backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Aura Forge',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Aura Forge Desktop.',
    ...
    native: {
      ...
      inputBody: 'Aura Forge is waiting for your response.',
      turnDoneTitle: 'Aura Forge finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Aura Forge defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Aura Forge backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Aura Forge backend to manage this plugin from Desktop.',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Aura Forge is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Aura Forge asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Aura Forge was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Aura Forge was in the background.'
        }
      },
      test: 'Send test notification',
      testTitle: 'Aura Forge',
    ...
    searchPlaceholder: {
      about: 'About Aura Forge Desktop',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Aura Forge follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Aura Forge can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Aura Forge when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Aura Forge walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Aura Forge is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Aura Forge, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'Aura Forge Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Aura Forge runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'Aura Forge checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Aura Forge configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Aura Forge.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Aura Forge gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Aura Forge Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Aura Forge Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Aura Forge runtime managed by this app.',
      kindRemoteDesc: 'A Aura Forge gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Aura Forge Cloud account.',
      kindSshDesc: 'A Aura Forge install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Aura Forge manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Aura Forge Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Aura Forge backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      ...
      localDesc: 'Start a private Aura Forge backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Aura Forge backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Aura Forge Cloud',
      cloudDesc: 'Sign in once to Aura Forge Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Aura Forge Cloud',
      cloudSignIn: 'Sign in to Aura Forge Cloud',
      cloudSignedIn: 'Signed in to Aura Forge Cloud',
      cloudNeedsSignIn: 'Sign in to Aura Forge Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Aura Forge Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Aura Forge Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Aura Forge Cloud',
      cloudSignedOutMessage: 'Cleared the Aura Forge Cloud session.',
      ...
      restartingMessage: 'Aura Forge Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Aura Forge ${version}` : ''}`,
      ...
      sshDesc:
        'Aura Forge is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Aura Forge path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Aura Forge found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Aura Forge runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Aura Forge is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the Aura Forge path.',
      sshErrPlatform:
        'Unsupported remote platform. Aura Forge Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Aura Forge on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Aura Forge. Review the exact configuration below — it comes from the link, not from Aura Forge.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Aura Forge runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Aura Forge at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  starmap: {
    ...
    emptyDesc: 'As Aura Forge builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Aura Forge to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Aura Forge to generate pets.',
      backgroundHint: 'You can close this — Aura Forge will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Aura Forge desktop' },
    ...
    hermesActiveSessions: (version, count) => `Aura Forge ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Aura Forge environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Aura Forge did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Aura Forge will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Aura Forge backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Aura Forge. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Aura Forge backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Aura Forge...',
    placeholderReconnecting: 'Reconnecting to Aura Forge…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Aura Forge a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Aura Forge will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Aura Forge to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Aura Forge…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Aura Forge…',
    ...
    unsupportedMessage: 'This version of Aura Forge can’t update itself from inside the app.',
    ...
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Aura Forge desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Aura Forge updater takes over in its own window and reopens Aura Forge automatically when it’s done. Please don’t reopen Aura Forge yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Aura Forge reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Aura Forge reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Aura Forge?',
    blockerBody:
      'Aura Forge needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Aura Forge',
    foreignBlockerBody:
      'Aura Forge can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Aura Forge can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Aura Forge needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Aura Forge Desktop',
    setupChoiceDesc:
      'Connect this app to a Aura Forge gateway you already run, or install Aura Forge locally on this computer.',
    connectExistingTitle: 'Connect to existing Aura Forge',
    ...
    installLocalTitle: 'Install Aura Forge locally',
    ...
    probeError: 'Could not reach that Aura Forge gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Aura Forge Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Aura Forge CLI or desktop instance is running. Stop any running Aura Forge instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Aura Forge Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Aura Forge is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Aura Forge…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Aura Forge',
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Aura Forge connects automatically',
    ...
    authorizeThere: 'Authorize Aura Forge there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Aura Forge there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Aura Forge Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Aura Forge Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Aura Forge will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Aura Forge is restarting...',
      askRestart: 'Ask Aura Forge to restart the server',
      lookingRestart: taskId => `Aura Forge is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Aura Forge is working in the background. Watch the preview console for progress.',
      ...
      restartFailedMessage: 'Aura Forge could not restart the server.',
      stillWorking:
        'Aura Forge is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Aura Forge is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Aura Forge gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Aura Forge won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Aura Forge needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Aura Forge needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Aura Forge Desktop to use Save Image.',
    restartToSaveImages: 'Restart Aura Forge Desktop to save images',
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Aura Forge loads when the work calls for them.'
      },
      messaging: {
        title: 'Aura Forge away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Aura Forge made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Aura Forge — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
