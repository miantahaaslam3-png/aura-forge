...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should Aura Forge look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} Aura Forge need to see?`,
    ...
    {
      headline: `What should ${label} Aura Forge tackle?`,
