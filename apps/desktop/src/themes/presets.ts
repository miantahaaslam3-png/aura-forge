...
/**
 * Nous — the canonical Aura Forge desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Aura Forge's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Aura Forge desktop identity: GitHub's chrome carrying Nous
