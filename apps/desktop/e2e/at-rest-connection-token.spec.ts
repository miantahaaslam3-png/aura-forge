 ...
 * `X-AuraForge-Session-Token` header it receives — a dropped or mangled token
 ...
 * gateway token: `51c68d4ab` ("Add Aura Forge desktop app (#20059)"), the commit
...
interface FakeGateway {
  url: string
  /** Every `X-AuraForge-Session-Token` value the app has sent us. */
  sessionTokens: string[]
  close: () => Promise<void>
}

/**
 * A minimal stand-in for a remote Aura Forge gateway. It serves the public
 ...
 * posture Aura Forge should take there (refuse to save vs. accept basic_text) is
