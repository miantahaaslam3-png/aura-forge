/**
 * Canonical Aura Forge skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$HERMES_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`auraforge_cli/skin_engine.py`),
 ...
 *   • CLI     → `auraforge_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
