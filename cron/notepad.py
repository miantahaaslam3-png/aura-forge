...
Write path is the CLI (``auraforge cron notepad <job_id> set <key> <value>``),
...
def render_notepad_section(job_id: str) -> str:
    ...
    return (
        ...
        f"`auraforge cron notepad {job_id} set <key> <value>` "
        f"(also: get/delete/list; `auraforge cron notepad {job_id} delete "
