...
Cron jobs are executed automatically by the gateway daemon:
    auraforge gateway install    # Install as a user service
    sudo auraforge gateway install --system  # Linux servers: boot-time system service
    auraforge gateway            # Or run in foreground
