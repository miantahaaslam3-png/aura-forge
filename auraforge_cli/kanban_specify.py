...
Used by ``auraforge kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``auraforge_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Aura Forge Agent board.
...
def _profile_author() -> str:
    """Mirror of ``auraforge_cli.kanban._profile_author``. Kept local to
