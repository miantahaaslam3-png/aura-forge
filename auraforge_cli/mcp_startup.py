...
def _has_configured_mcp_servers() -> bool:
    ...
    try:
        ...
        if isinstance(mcp_servers, dict) and len(mcp_servers) > 0:
            return True
        from auraforge_cli.agent_plugins import has_enabled_agent_plugin_mcp
...
def start_background_mcp_discovery(*, logger, thread_name: str) -> None:
    ...
    with _mcp_discovery_lock:
        ...
        try:
            from auraforge_constants import get_aura_forge_home_override
        ...
        def _discover() -> None:
            token = None
            try:
                from auraforge_constants import set_aura_forge_home_override
            ...
            try:
                ...
                if token is not None:
                    try:
                        from auraforge_constants import reset_aura_forge_home_override
...
def _resolve_discovery_timeout(
    ...
    try:
        from auraforge_cli.config import load_config, DEFAULT_CONFIG
