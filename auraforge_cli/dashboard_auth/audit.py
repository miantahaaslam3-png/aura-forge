...
Profile-aware location: ``$AURA_FORGE_HOME/logs/dashboard-auth.log``.
...
from ``auraforge_constants`` or other auraforge_cli modules — so it can be
...
def _resolve_log_path() -> Path:
    ...
    Uses ``auraforge_constants.get_aura_forge_home()`` (a leaf module — no import
