...
``tests/auraforge_cli/test_dashboard_auth_401_reauth.py``.
"""
...
See the <a href="https://aura-forge-agent.nousresearch.com/docs/user-guide/features/web-dashboard#authentication-gated-mode">dashboard
