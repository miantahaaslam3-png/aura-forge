"""``auraforge gui`` subcommand parser.
...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description=(
            "Launch the Aura Forge Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        "--identity",
        default="Aura Forge Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: Aura Forge Local Signing)",
    )
