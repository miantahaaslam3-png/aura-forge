...
Follows the pattern of ``auraforge_cli/subcommands/doctor.py``: parser built
...
def build_verify_parser(subparsers, *, cmd_verify: Callable) -> None:
    ...
    verify_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "(or load the saved manifest at .auraforge/environment.json), then "
    ...
    verify_parser.add_argument(
        "--save",
        action="store_true",
        help="Save the recipe as .auraforge/environment.json in the project",
    )
    verify_parser.add_argument(
        "--skip-start",
        action="store_true",
