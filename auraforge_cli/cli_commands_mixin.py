...
``cli.py``'s ``Aura ForgeCLI`` class. ``Aura ForgeCLI`` inherits ``CLICommandsMixin`` so
...
from auraforge_constants import display_aura_forge_home, is_termux as _is_termux_environment
...
class CLICommandsMixin:
    ...
    def _handle_rollback_command(self, command: str):
        ...
        Syntax:
            ...
            /rollback <N> --all       — classic full restore (may overwrite
                                        files you edited after Aura Forge did)
        ...
        if not mgr.enabled:
            ...
            print("  Enable with: auraforge --checkpoints")
    ...
    def _handle_diff_command(self, command: str):
        ...
        Syntax:
            ...
            /diff session          — everything Aura Forge changed (checkpoint baseline)
    ...
    def _print_session_diff(self, cwd: str, stat_only: bool):
        ...
        if result.get("empty") or (not stat and not diff):
            print("  No changes — Aura Forge hasn't edited any files here yet.")
            return
    ...
    def _handle_snapshot_command(self, command: str):
        """Handle /snapshot — lightweight state snapshots for Aura Forge config/state.
        ...
        if subcmd in {"list", "ls"}:
            ...
            if not snaps:
                ...
                return
            print(f"  State snapshots ({display_aura_forge_home()}/state-snapshots/):\n")
    ...
    def _handle_export_command(self, command: str):
        ...
        """
        from auraforge_cli.profiles import export_profile, get_active_profile_name
    ...
    def _handle_import_command(self, command: str):
        ...
        try:
            ...
            pass
        print(f"  Use it: auraforge -p {imported}")
    ...
    def _handle_paste_command(self):
        ...
        from auraforge_cli.clipboard import has_clipboard_image
    ...
    def _handle_copy_command(self, cmd_original: str) -> None:
        ...
        try:
            from auraforge_cli.clipboard import (
    ...
    def _handle_image_command(self, cmd_original: str):
        ...
        if _remainder:
            ...
            _cprint(f"  {_DIM}Tip: type your next message, or run auraforge chat -q --image {_termux_example_image_path(image_path.name)} \"What do you see?\"{_RST}")
    ...
    def _handle_tools_command(self, cmd: str):
        ...
        def _run_capture(ns: Namespace) -> None:
            ...
            # Buffer reports isatty()=True so color() in auraforge_cli/colors.py
    ...
    def _handle_profile_command(self):
        ...
        from auraforge_cli.slash_exec import CommandContext, execute_command
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if target.isdigit():
            ...
            from auraforge_cli.main import _resolve_session_by_name_or_id
    ...
    def _handle_worktree_command(self, cmd_original: str) -> None:
        ...
        (auraforge_cli/worktree_gc.py): never deletes tracked changes, unique
    ...
    def _handle_personality_command(self, cmd: str):
        ...
        All resolution/persistence goes through auraforge_cli.personality —
    ...
    def _handle_pet_command(self, cmd: str):
        ...
        from auraforge_cli.pets import _set_active, _set_enabled, print_pet_gallery, set_pet_scale, toggle_pet_display
    ...
    def _handle_hatch_command(self, cmd: str):
        ...
        from auraforge_cli.pets import _set_active
    ...
    def _handle_suggestions_command(self, cmd: str):
        ...
        args = " ".join(tokens)
        try:
            from auraforge_cli.suggestions_cmd import handle_suggestions_command
    ...
    def _handle_blueprint_command(self, cmd: str):
        ...
        try:
            from auraforge_cli.blueprint_cmd import handle_blueprint_command
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        Delegates to auraforge_cli.curator so the CLI and the `auraforge curator`
        ...
        try:
            from auraforge_cli.curator import cli_main
            cli_main(tokens)
        except SystemExit:
    ...
    def _handle_skills_command(self, cmd: str):
        """Handle /skills slash command — delegates to auraforge_cli.skills_hub."""
        ...
        if args and args[0].lower() in {"pending", "approve", "apply", "reject",
            ...
            from auraforge_cli.write_approval_commands import handle_pending_subcommand
    ...
    def _handle_init_command(self, cmd: str):
        ...
        """
        from auraforge_cli.init_command import build_init_prompt_for_cwd
    ...
    def _handle_background_command(self, cmd: str):
        ...
        def run_background():
            ...
            try:
                ...
                if response:
                    try:
                        from auraforge_cli.skin_engine import get_active_skin
                        _skin = get_active_skin()
                        label = _skin.get_branding("response_label", "⚕ Aura Forge")
    ...
    def _handle_bundles_command(self, cmd: str) -> None:
        ...
        if not bundles:
            ...
            _cprint(
                f"  {_DIM}Create one with: auraforge bundles create "
        ...
        if sub.startswith("connect"):
            ...
            if hasattr(self, '_pending_input'):
                self._pending_input.put(
                    ...
                    "just because CDP is connected. This is typically a Aura Forge-managed isolated debug "
    ...
    def _handle_heartbeat_command(self, cmd: str) -> None:
        ...
        from auraforge_cli.heartbeat import parse_interval, format_interval
        ...
        if interval is None:
            ...
            return
        if interval < 0:
            from auraforge_cli.heartbeat import MIN_INTERVAL_SECONDS
    ...
    def _handle_goal_command(self, cmd: str) -> None:
        ...
        _cprint(
            ...
            f"Aura Forge keeps working until it is, you pause/clear it, or the budget is "
    ...
    def _handle_goal_draft(self, objective: str) -> None:
        ...
        from cli import _DIM, _RST, _cprint
        from auraforge_cli.goals import draft_contract
    ...
    def _handle_loop_command(self, cmd: str) -> None:
        ...
        from auraforge_cli.loops import dispatch_loop_command
        ...
        if result.get("created"):
            try:
                from auraforge_cli.loops import goal_blocks_loop_tick
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        try:
            from auraforge_cli.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
        ...
        if len(parts) < 2 or not parts[1].strip():
            ...
            print("\n  Usage: /skin <name>")
            print(f"  Custom skins: drop a YAML file in {display_aura_forge_home()}/skins/\n")
            return
    ...
    def _handle_focus_command(self, cmd_original: str) -> None:
        ...
        from auraforge_cli.colors import Colors as _Colors
    ...
    def _set_tool_progress_mode(self, mode: str) -> None:
        ...
        """
        from auraforge_cli.focus_view import normalize_tool_progress_mode
    ...
    def _note_focus_hidden_line(self, function_name: str) -> None:
        ...
        if not getattr(self, "_focus_view_enabled", False):
            return
        from auraforge_cli.focus_view import would_display_tool_line
    ...
    def _emit_focus_recovery_line(self) -> None:
        ...
        if not getattr(self, "_focus_view_enabled", False):
            return
        from auraforge_cli.focus_view import format_hidden_line
    ...
    def _handle_approvals_command(self, cmd_original: str) -> None:
        ...
        from cli import _cprint
        from auraforge_cli.approval_mode import run_approval_mode_command
    ...
    def _handle_busy_command(self, cmd: str):
        """Handle /busy — control what Enter does while Aura Forge is working.
        ...
        if save_config_value("display.busy_input_mode", arg):
            if arg == "queue":
                behavior = "Enter will queue follow-up input while Aura Forge is busy."
            elif arg == "steer":
                behavior = "Enter will steer your message into the current run (after the next tool call)."
            else:
                behavior = "Enter will redirect the current run while Aura Forge is busy; /stop still cancels it."
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from auraforge_cli.models import _is_anthropic_fast_model
            agent = getattr(self, "agent", None)
    ...
    def _handle_update_command(self) -> bool:
        ...
        when cancelled.
        """
        from auraforge_cli.config import is_managed, format_managed_message

        if is_managed():
            print(f"  ✗ {format_managed_message('update Aura Forge Agent')}")
            return False
        ...
        choices = [
            ("once", "Update Now", "exit the current session and update Aura Forge Agent"),
    ...
    def _handle_wake_command(self, command: str):
        """Handle /wake [on|off|status] — the 'Hey Aura Forge' hotword listener.
