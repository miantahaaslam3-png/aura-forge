"""
Security advisory checker for Aura Forge Agent.
...
run in environments where the rest of Aura Forge failed to import.
"""
...
def _installed_version(pkg_name: str) -> Optional[str]:
    ...
    except ImportError:  # py<3.8 — Aura Forge requires 3.10+ but defensive.
        return None
    try:
