...
Mirrors the structure of ``auraforge_cli/skills_hub.py`` but for skill
...
def _cmd_list(args) -> None:
    ...
    if not bundles:
        c.print(
            ...
            f"  auraforge bundles create <name> --skill skill1 --skill skill2[/]\n"
...
def register_cli(subparser) -> None:
    ...
    Called from ``auraforge_cli/main.py`` where it owns the top-level
