"""Durable aggregation and local export for Aura Forge shared metrics."""
...
from auraforge_cli.sqlite_util import write_txn
...
class SharedMetricsStore:
    ...
    def _ensure_schema(self) -> None:
        with self._connection(busy_timeout_ms=_SCHEMA_BUSY_TIMEOUT_MS) as connection:
            # Serialize first-run creation and upgrades across Aura Forge processes.
            with write_txn(connection):
