...
The Aura Forge docs site hosts a JSON manifest of curated models for providers
...
DEFAULT_CATALOG_FALLBACK_URLS: tuple[str, ...] = (
    "https://raw.githubusercontent.com/miantahaaslam3-png/aura-forge/main/website/static/api/model-catalog.json",
)
DEFAULT_TTL_HOURS = 1
...
def get_default_model_from_cache(provider: str) -> str | None:
    ...
    ``"default": true``; that entry is the model Aura Forge silently lands on when
