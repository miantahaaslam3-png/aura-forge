"""Persistent session goals — the Ralph loop for Aura Forge.

A goal is a free-form user objective that stays active across turns. After
each turn completes, a small judge call asks an auxiliary model "is this
goal satisfied by the assistant's last response?". If not, Aura Forge feeds a
...
# creation, and the first auraforge_cli.config import (journal-mode
