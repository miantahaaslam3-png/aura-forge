...
Entry point: ``auraforge whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``auraforge_cli/main.py``).
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Aura Forge to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Aura Forge needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Aura Forge gateway in another terminal:")
    print("         auraforge gateway")
    print()
    ...
    print()
    print("  Docs: https://aura-forge-agent.nousresearch.com/docs/user-guide/")
