...
Invoked by ``auraforge kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Aura Forge Agent board.
...
def _profile_author() -> str:
    """Mirror of ``auraforge_cli.kanban._profile_author``."""
    return (
