...
from auraforge_cli.config import atomic_config_write, cfg_get, clear_model_endpoint_credentials
from utils import (
    atomic_json_write,
...
class GatewaySlashCommandsMixin:
    ...
    def _typed_command_prefix_for(self, platform) -> str:
        """Return the prefix users can always type to reach Aura Forge commands.
    ...
    async def _handle_reset_command(self, event: MessageEvent) -> Union[str, EphemeralReply]:
        ...
        try:
            from auraforge_cli.lifecycle import invoke_hook as _invoke_hook
        ...
        try:
            from auraforge_cli.tips import get_random_tip
    ...
    async def _handle_version_command(self, event: MessageEvent) -> str:
        """Handle /version — show the running Aura Forge Agent version."""
        from auraforge_cli.slash_exec import CommandContext, execute_command
    ...
    async def _handle_model_command(self, event: MessageEvent) -> Optional[str]:
        ...
        # via the shared single-owner parser (auraforge_cli.model_switch).
            ...
            if has_picker:
                ...
                if providers:
                    ...
                    async def _on_model_selected_scoped(
                        ...
                        try:
                            from auraforge_cli.context_switch_guard import (
                        ...
                        from auraforge_cli.model_switch import format_model_for_display
                        ...
                        if persist_global:
                            try:
                                ...
                                if isinstance(_raw_model, dict):
                                    ...
                                    _persist_cfg["model"] = _persist_model_cfg
                                try:
                                    from auraforge_cli.route_identity import should_clear_context_pin_async
                        ...
                        from auraforge_cli.model_switch import resolve_display_context_length_async
                        _sw_config_ctx = None
                        _sw_model_cfg = {}
                        try:
    ...
    async def _handle_codex_runtime_command(self, event: MessageEvent) -> str:
        ...
        Same surface as the CLI handler in cli.py:
            ...
            /codex-runtime auto             — Aura Forge default runtime
        ...
        from auraforge_cli import codex_runtime_switch as crs
    ...
    async def _handle_personality_command(self, event: MessageEvent) -> str:
        ...
        # Persist the selection only — auraforge_cli.personality never writes
    ...
    async def _handle_heartbeat_command(self, event: "MessageEvent") -> str:
        ...
        """
        from auraforge_cli.heartbeat import parse_interval, format_interval, MIN_INTERVAL_SECONDS
    ...
    async def _handle_loop_command(self, event: "MessageEvent") -> str:
        ...
        """
        try:
            from auraforge_cli.loops import dispatch_loop_command, goal_blocks_loop_tick
        except Exception as exc:
    ...
    async def _handle_diff_command(self, event: MessageEvent) -> str:
        ...
        Aura Forge itself changed. ``--stat`` limits output to the summary.
    ...
    async def _handle_fast_command(self, event: MessageEvent) -> Optional[str]:
        ...
        from auraforge_cli.models import model_supports_fast_mode
    ...
    async def _handle_save_command(self, event: MessageEvent) -> str:
        ...
        """
        from auraforge_cli.session_export import (
            SAVE_USAGE,
        ...
        if redact:
            from auraforge_cli.session_export_md import redact_session_data
    ...
    async def _handle_sessions_command(self, event: MessageEvent) -> str:
        ...
        from auraforge_cli.session_listing import (
    ...
    async def _handle_branch_command(self, event: MessageEvent) -> str:
        ...
        try:
            await self._session_db.create_session(
                ...
                # path (auraforge_state.py:1994-2009) that searches by the complete
    ...
    async def _handle_update_command(self, event: MessageEvent) -> str:
        ...
        if is_managed():
            return f"✗ {format_managed_message('update Aura Forge Agent')}"
