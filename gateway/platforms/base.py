...
# Audio file extensions Aura Forge recognizes for native audio delivery.
# Keep Telegram's narrower attachment/voice sets below separate: formats such
# as MPEG-2 Layer II are audio to Aura Forge but unsupported by sendAudio/sendVoice.
_AUDIO_MIME_TYPES = {
    ".ogg": "audio/ogg",
    ".opus": "audio/opus",
    ".mp3": "audio/mpeg",
...
def _thread_metadata_for_source(source, reply_to_message_id: str | None = None) -> dict | None:
    ...
    value. Telegram private-chat topics created through Aura Forge' DM-topic helper
...
def _profile_cache_roots() -> List[Path]:
    """Return per-profile canonical cache roots under the shared Aura Forge root.
...
def _media_delivery_denied_paths() -> List[Path]:
    ...
    # The active Aura Forge profile and shared Aura Forge root both contain control
...
class BasePlatformAdapter(ABC):
    ...
    # Aura Forge commands.  Default "/" (most platforms deliver "/approve" etc.
    ...
    def prefers_fresh_final_streaming(
        ...
        implementation supports. Telegram is the motivating case: Aura Forge sends
    ...
    async def send_voice(
        ...
        **kwargs,
        ...
        host filesystem path that would leak the Aura Forge home layout.
        """
    ...
    async def send_video(
        ...
        **kwargs,
        ...
        would leak the Aura Forge home layout.
        """
