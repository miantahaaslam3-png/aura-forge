...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Aura Forge session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Aura Forge session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Aura Forge agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Aura Forge Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Aura Forge gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Aura Forge session in it",
