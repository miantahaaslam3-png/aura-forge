...
# cwd at all, or one whose folder can't be promoted (the bare home dir, AURA_FORGE
...
def build_tree(
    ...
    *,
    ...
    workspaces even when their parent tree contains Aura Forge state. User-created
