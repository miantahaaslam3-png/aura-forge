"""
Aura Forge MCP Server — expose messaging conversations as MCP tools.
...
class EventBridge:
    ...
    This is the Aura Forge equivalent of OpenClaw's WebSocket gateway bridge.
...
def create_mcp_server(event_bridge: Optional[EventBridge] = None) -> "MCPServer":
    """Create and return the Aura Forge MCP server with all tools registered."""
...
def run_mcp_server(verbose: bool = False) -> None:
    """Start the Aura Forge MCP server on stdio."""
    if not _MCP_SERVER_AVAILABLE:
        print(
